...
function localizeAgentsError(error: string): string {
  const lower = error.toLowerCase();
  if (!lower.includes("unauthorized")) {
    return error;
  }
  if (lower.includes("gateway token missing")) {
    return t("agentsPage.errors.gatewayTokenMissing");
  }
  if (lower.includes("gateway token mismatch")) {
    return t("agentsPage.errors.gatewayTokenMismatch");
  }
  if (lower.includes("too many failed authentication attempts")) {
    return t("agentsPage.errors.authRateLimited");
  }
  if (lower.includes("authentication failed")) {
    return t("agentsPage.errors.authFailed");
  }
  return t("agentsPage.errors.unauthorized");
}
    ...
    <div class="agents-layout">
      <section class="card agents-sidebar">
        <div class="row" style="justify-content: space-between;">
          <div>
            <div class="card-title">${t("agentsPage.sidebar.title")}</div>
            <div class="card-sub">${t("agentsPage.sidebar.configured", { count: String(agents.length) })}</div>
          </div>
          ...
          props.error
            ? html`
                <div class="callout danger" style="margin-top: 12px;">
                  ${localizeAgentsError(props.error)}
                </div>
              `
            : nothing
        }
      ...
      <section class="agents-main">
        ${
          !selectedAgent
            ? html`
                <div class="card">
                  <div class="card-title">${t("agentsPage.main.selectTitle")}</div>
                  <div class="card-sub">${t("agentsPage.main.selectSubtitle")}</div>
                </div>
              `
            : html`
                ${renderAgentHeader(
...
function renderAgentHeader(
  ...
  const subtitle = agent.identity?.theme?.trim() || t("agentsPage.main.defaultSubtitle");
...
function renderAgentOverview(params: {
  ...
  const identityStatus = agentIdentityLoading
    ? t("agentsPage.common.loading")
    : agentIdentityError
      ? t("agentsPage.overview.unavailable")
      : "";
    ...
    <section class="card">
      ...
      <div class="agents-overview-grid" style="margin-top: 16px;">
        ...
        <div class="agent-kv">
          ...
          <div>${isDefault ? t("cron.summary.yes") : t("cron.summary.no")}</div>
        </div>
        <div class="agent-kv">
      ...
      <div class="agent-model-select" style="margin-top: 20px;">
        ...
        <div class="row" style="justify-content: flex-end; gap: 8px;">
          ...
          <button
            ...
            @click=${onConfigSave}
          >
            ${configSaving ? t("agentsPage.common.saving") : t("agentsPage.common.save")}
          </button>
        </div>
      </div>
    </section>
